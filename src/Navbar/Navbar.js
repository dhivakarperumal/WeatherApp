    ...
    return (
        <>
            ...
            <Navbar expand="lg" className="navbar" id="navbar">
                <Container>
                    <Navbar.Brand href="#home" className="logo"><img src={require('../assert/clogo.png')} width={40} height={40} alt="" className="logos" /> MyWeather</Navbar.Brand>
                    <Navbar.Toggle aria-controls="basic-navbar-nav" />
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="m-auto header_color">
                            ...
                            <Nav.Link href="#link" className="header_color">Gallary</Nav.Link>
